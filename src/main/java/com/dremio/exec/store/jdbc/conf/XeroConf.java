...
@SourceType(value = "XeroARP", label = "Xero",uiConfig = "xero-layout.json")
public class XeroConf extends AbstractArpConf<XeroConf> {
  private static final String ARP_FILENAME = "arp/implementation/xero-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.xero.XeroDriver";
